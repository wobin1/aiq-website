  ...
  _edge(i, e0, e1, P, j) {
    ...
    if (P.length > 4) {
      for (let i2 = 0; i2 < P.length; i2 += 2) {
        ...
        if (P[i2] === P[j2] && P[j2] === P[k2] || P[i2 + 1] === P[j2 + 1] && P[j2 + 1] === P[k2 + 1]) P.splice(j2, 2), i2 -= 2;
      }
    }
    return j;
  }
...
function circle_default() {
  var center2 = constant_default8([0, 0]), radius = constant_default8(90), precision = constant_default8(6), ring, rotate, stream = {
    point: point6
  };
...
var symbolsStroke = [circle_default3, plus_default, x_default3, triangle2_default, asterisk_default, square2_default, diamond2_default];
